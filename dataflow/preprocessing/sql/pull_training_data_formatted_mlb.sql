...
WHERE (g.genre_cat_final = 'MLB' AND e.season = 2019)  -- below, these are required data filtering logic:
  ...
  AND lower(e.game_type) IN ('regular','post-season')  -- consider only e.g. regular season and post-season games
